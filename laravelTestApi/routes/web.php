...
Route::get('species', 'App\Http\Controllers\Web\SpeciesController@index')->middleware('auth');
Route::get('species/{id}', 'App\Http\Controllers\Web\SpeciesController@show')->middleware('auth');
Route::post('species', 'App\Http\Controllers\Web\SpeciesController@store')->middleware('auth');
Route::put('species/{id}', 'App\Http\Controllers\Web\SpeciesController@update')->middleware('auth');
